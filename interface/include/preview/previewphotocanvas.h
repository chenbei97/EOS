...
public: // 鼠标事件,previewphotocanvas_mouse.cpp
...
public:// 绘图的函数,定义在previewphotocanvas_paint.cpp
...
private: // 绘制视野正方形区域所有需要计算的东西,定义在previewphotocanvas_geometry.cpp
...
public: // 定义在previewphotocanvas_geometry.cpp
